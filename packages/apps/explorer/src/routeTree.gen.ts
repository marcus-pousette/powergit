...
const repoIndex = createRoute({ getParentRoute: () => rootRoute, path: 'org/$orgId/repo/$repoId/', component: RepoIndex.RepoOverviewComponent })
const repoBranches = createRoute({ getParentRoute: () => rootRoute, path: 'org/$orgId/repo/$repoId/branches', component: RepoBranches.BranchesComponent })
const repoCommits = createRoute({ getParentRoute: () => rootRoute, path: 'org/$orgId/repo/$repoId/commits', component: RepoCommits.CommitsComponent })
const repoFiles = createRoute({ getParentRoute: () => rootRoute, path: 'org/$orgId/repo/$repoId/files', component: RepoFiles.FilesComponent })
